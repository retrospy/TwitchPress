...
if ( ! class_exists( 'TwitchPress_ListTable_APIOutcomes' ) ) {
    require_once( 'class.twitchpress-listtable-apioutcomes.php' );
}
 ...
 * @version     1.0
 */
class TwitchPress_DataView_APIOutcomes extends TwitchPress_ListTable_APIOutcomes {
