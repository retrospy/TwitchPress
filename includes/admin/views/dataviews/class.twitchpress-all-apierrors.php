...
if ( ! class_exists( 'TwitchPress_ListTable_APIErrors' ) ) {
    require_once( 'class.twitchpress-listtable-apierrors.php' );
}
 ...
 * @version     1.0
 */
class TwitchPress_DataView_All_APIErrors extends TwitchPress_ListTable_APIErrors {
