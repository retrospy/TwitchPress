...
<div id="message" class="updated twitchpress-message twitchpress-connect">
    <p><?php _e( '<strong>Welcome to WordPress TwitchPress</strong> &#8211; You&lsquo;re almost ready to begin using the plugin. It is recommended that you now complete the Setup Wizard to configure TwitchPress.', 'twitchpress' ); ?></p>
