...
class TwitchPress_Public_PreSet_Notices {
    ...
    */
    public function message_list() {      
        ...
        $messages_array['login'][6] = array( 'type' => 1, 'title' => __( 'User Permission Required', 'twitchpress' ), 'info' => __( 'Permission to read (get) a Twitch users email address has not been giving - cannot complete login.', 'twitchpress' ) );
        ...
        $messages_array['login'][11] = array( 'type' => 1, 'title' => __( 'Please Sign-Up', 'twitchpress' ), 'info' => __( 'You connected with a Twitch channel that has not been registered. This site does not allow automatic registration using Twitch. Please go to the registration page and create an account using the same email address as used in your Twitch account.', 'twitchpress' ) );
        ...
        $messages_array['login'][15] = array( 'type' => 0, 'title' => __( 'Registration Complete', 'twitchpress' ), 'info' => __( 'You have been registered on this site using your Twitch account. You can use your Twitch account to sign-in anytime.', 'twitchpress' ) );
