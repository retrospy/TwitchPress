...
if ( ! class_exists( 'TwitchPress_ListTable_BugNet_Issue' ) ) {
    require_once( 'class.twitchpress-listtable-bugnet-issues.php' );
}

/**
 * TwitchPress_DataView_All_DailyLogs usually showing ALL items without filter.
 * 
 ...
 * @version     1.0.0
 */
class TwitchPress_DataView_All_BugNet_Issues extends TwitchPress_ListTable_BugNet_Issues {
