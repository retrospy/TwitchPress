...
if ( ! class_exists( 'TwitchPress_ListTable_Endpoints' ) ) {
    require_once( 'class.twitchpress-listtable-endpoints.php' );
}
 ...
 * @version     1.0.0
 */
class TwitchPress_DataView_Endpoints extends TwitchPress_ListTable_Endpoints {
