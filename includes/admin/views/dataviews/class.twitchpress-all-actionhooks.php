...
if ( ! class_exists( 'TwitchPress_ListTable_ActionHooks' ) ) {
    require_once( 'class.twitchpress-listtable-actionhooks.php' );
}

/**
 * Table for viewing action hook history by BugNet.
 *
 * @author      Ryan Bayne
 * @category    Admin
 ...
 * @version     1.0
 */
class TwitchPress_DataView_All_ActionHooks extends TwitchPress_ListTable_ActionHooks {
