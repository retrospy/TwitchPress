...
class TwitchPress_Admin_Settings {
    ...
    */
    ...
    public static function get_settings_pages() {
        if ( empty( self::$settings ) ) {
            ...
            $settings[] = include( 'settings/class.twitchpress-settings-giveaways.php' );    
    ...
    */
    ...
    public static function output() {
        ...
        $save_button_text = apply_filters( 'twitchpress_settings_save_button_text', __( 'Save changes' , 'twitchpress' ) );
